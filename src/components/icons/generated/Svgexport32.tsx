...
/**
 * Svgexport32 Icon
 * Generated from: svgexport-32.svg
 */
export const Svgexport32 = React.forwardRef<SVGSVGElement, SVGIconProps>(
  ({ size = 24, className = "", ...props }, ref) => (
    <SVGIcon
      ref={ref}
      size={size}
      viewBox="52 31.5 96 137"
      className={className}
      {...props}
    >
...
Svgexport32.displayName = "Svgexport32";
