            ...
            <div className=" grid grid-cols-12 justify-between  w-full gap-20 items-end ">
              <section className="space-y-8  flex-1 col-span-6">
                ...
                <article className="mt-8 ">
                  <h2 className="text-white text-6xl md:text-7xl mb-2 font-bold">
                    Build Better
                  </h2>
                ...
                <div className="flex gap-4">
                  <Button
                    className="flex font-medium items-center gap-2 bg-accent text-white  px-6 py-3 rounded-lg transition-all duration-300 hover:bg-accent/90 [box-shadow:0_25px_30px_-12px_#DBA4004D] h-14 w-60 text-[18px] "
                    style={
                      {
