...
export function TrustedSection() {
  return (
    <section className=" py-16 ">
      <div className="relative  mx-auto overflow-hidden   bg-accent ">
        <div className="max-w-5xl  mx-auto flex flex-col md:flex-row items-center justify-between ">
          <div className="absolute pointer-events-none top-10 -z-1 left-20 size-64 bg-gradient-to-b from-accent/30 to-primary/20 blur-[180px]" />
          ...
          <div className="flex flex-col items-center md:items-start max-md:text-center">
            <div className="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-accent bg-accent/15">
              <span className="bg-accent text-primary text-xs px-3.5 py-1 rounded-full font-medium">
                NEW
              </span>
            ...
            <h1 className="text-3xl font-medium max-w-xl mt-5  text- bg-clip-text">
              Trusted by leading companies.
            </h1>

            <p className="text-base text-muted-foreground max-w-lg mt-4">
              Built to integrate effortlessly with your existing tools,
              frameworks and workflows — so you can move faster.
            </p>

            <Button
              variant="outline"
              className="flex items-center gap-2 text-sm px-6 py-2.5 border-accent/30  active:scale-95 transition rounded-full mt-6 "
            >
              Read more
              <svg
                width="13"
