...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento x row-span-1 shadow shadow-primary/10 flex flex-col justify-between space-y-4 rounded-xl   p-4 transition duration-200 hover:shadow-md dark:border-white/[0.2] dark:bg-black dark:shadow-none",
        className
      )}
    >
      {header}
